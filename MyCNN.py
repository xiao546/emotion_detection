...
class CNN_net:
    ...
    def build(self, inputs, is_training):
        ...
        with slim.arg_scope([slim.conv2d, slim.fully_connected],
            ...
            conv2 = slim.conv2d(pool1, 64, 3, padding='SAME')
            conv2 = slim.conv2d(conv2, 64, 1, padding='SAME')
            conv2 = slim.conv2d(conv2, 96, 3, padding='SAME')
            ...
            conv4 = slim.conv2d(conv3, 128, 1, padding='SAME')
            ...
            conv6 = slim.conv2d(pool3, 2048, 5, padding='SAME')
            conv6 = slim.conv2d(conv6, 1024, 5, padding='SAME')
